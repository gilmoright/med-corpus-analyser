...
Например такие поля: Препарат, АТХ препарата, заболевание, мкб, симптомы, симптомы по меддре (возможно в одном keywords поле с предыдущими), количество отзывов, отзывов с положительными резальтатами, с негативными, с адрами, с бесполезностью, список адр, список юрл отзывов.
Возможно групбай даже не нужен будет.
